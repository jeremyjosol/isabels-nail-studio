...
const About = () => {
  ...
  return (
    <section className="about">
      ...
      <p>
        There is a <strong>non-refundable</strong> deposit of $25 
        <br />that goes towards the total price of your service.
      </p>
      ...
      {isDetailsVisible && (
        <div className="details">
          <p className='follow-up'>
            Appointment availability is currently limited 
            ...
            <br />
            <br />
            Thank you. <FaHeart className='icons' /> 
          </p>
        </div>
      )}
    </section>
